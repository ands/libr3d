...
{
	{ R3D_PRIMITIVE_TYPE_TRIANGLES, vertices0, sizeof(vertex_t), sizeof(vertices0) / sizeof(vertex_t), 0 },
	{ R3D_PRIMITIVE_TYPE_TRIANGLES, vertices1, sizeof(vertex_t), sizeof(vertices1) / sizeof(vertex_t), 0 },
	{ R3D_PRIMITIVE_TYPE_TRIANGLES, vertices2, sizeof(vertex_t), sizeof(vertices2) / sizeof(vertex_t), 0 },
};
